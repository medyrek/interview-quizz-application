...
@Configuration
@EnableMongoRepositories("io.github.jhipster.interview.quizz.application.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.github.jhipster.interview.quizz.application.config.dbmigrations");
